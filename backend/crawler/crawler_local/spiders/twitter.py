...
class TwitterSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        artist = response.xpath(f"//*[@id={id}]/div[1]/h2/text()").extract()[0]
        sub = response.xpath(f"//*[@id={id}]/div[2]/span[2]/text()").extract()[0]
        date = response.xpath(f"//*[@id={id}]/div[6]/span[2]/text()").extract()[0]
        upload = response.xpath(f"//*[@id={id}]/div[5]/span[2]/text()").extract()[0]
