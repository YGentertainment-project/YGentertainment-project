        ...
        success: res => {
            ...
            datalist.forEach(data => {
                ...
                dataCol2.innerHTML = `<td style="width: 100px;">
                    <div class="row_layout" style="width: 100px;">
                        ...
                        <span style="white-space: nowrap;">시간마다</span>
                    </div>
                </td>`;
                ...
                <td style="width: 110px;">
                    <div class="row_layout" style="width: 110px;">
                        ...
                        <span style="white-space: nowrap;">분에 시작</span>
                    </div>
                </td>`;
