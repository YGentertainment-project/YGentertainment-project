    ...
    def post(self, request):
        ...
        try:
            ...
            for index,artist in enumerate(artists):
                ...
                past_listens = obj["listens"]
                past_streams = obj["streams"]
                if past_uploads is not None and past_uploads != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_uploads}-> {uploads[index]}]")
                if past_subscribers is not None and past_subscribers != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_subscribers}-> {uploads[index]}]")
                if past_views is not None and past_views != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_views}-> {uploads[index]}]")
                if past_videos is not None and past_videos != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_videos}-> {uploads[index]}]")
                if past_likes is not None and past_likes != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_likes}-> {uploads[index]}]")
                if past_plays is not None and past_plays != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_plays}-> {uploads[index]}]")
                if past_followers is not None and past_followers != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_followers}-> {uploads[index]}]")
                if past_twits is not None and past_twits != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_twits}-> {uploads[index]}]")
                if past_weverses is not None and past_weverses != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_weverses}-> {uploads[index]}]")
                if past_listens is not None and past_listens != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_listens}-> {uploads[index]}]")
                if past_streams is not None and past_streams != uploads[index]:
                    userlogger.info(f"[CHANGE]: {artist}'s uploads of {platform} [{past_streams}-> {uploads[index]}]")
